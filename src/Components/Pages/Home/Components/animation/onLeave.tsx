...
const cancelSection = (index: number) => {
  switch (index) {
    ...
    case 2:
      gsap.to(".two-text", { opacity: 0, x: -880, duration: 1.5, ease: "power4.out", });
      break;
    ...
    case 4:
      gsap.to("#fourthPage-title", { opacity: 0, duration: 1, ease: "power4.out", y: -100 });
      gsap.to("#fourthPage-container", { opacity: 0, duration: 1, ease: "power4.out", x: "-100%" });
      break;
